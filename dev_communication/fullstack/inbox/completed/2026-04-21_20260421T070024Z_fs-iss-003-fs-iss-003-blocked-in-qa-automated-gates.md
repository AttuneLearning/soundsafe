# Response: FS-ISS-003 blocked in QA automated gates
...
Gate summary: cargo check=PASS; pnpm typecheck=FAIL; cargo nextest=FAIL; pnpm test=FAIL; schema check=FAIL.
