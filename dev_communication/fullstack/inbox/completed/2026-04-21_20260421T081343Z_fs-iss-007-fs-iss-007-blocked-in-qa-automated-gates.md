# Response: FS-ISS-007 blocked in QA automated gates
...
Gate summary: cargo check=PASS; pnpm typecheck=FAIL; cargo nextest=PASS; pnpm test=PASS; schema check=PASS.
